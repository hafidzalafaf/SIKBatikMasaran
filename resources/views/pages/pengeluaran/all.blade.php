        ...
        <div class="card-box table-responsive">
            <div class="row">
                <p class="text-muted font-13 m-b-30 col-md-8 col-12">
                    Halaman ini menampilkan keseluruhan laporan pengeluaran.  Klik <span class="text-primary font-weight-bold">Cari</span> untuk mencari laporan sesuai tanggal awal sampai tanggal akhir ke dalam file excel.
                    </p>
            </div>
            ...
            <table id="pengeluaran-all" class="table table-striped table-bordered" style="width:100%">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="#" class="btn btn-danger btn-sm" name="tombol-hapus" id="tombol-hapus">Hapus</a>
        </div>
      </div>
    </div>
  </div>
    ...
    //CSRF TOKEN PADA HEADER
        ...
        $(document).ready(function () {
            ...
            // buttons: [ 'excel', 'pdf', 'print', 'csv', 'pageLength' ],
                initComplete: function () {
                    ...
                    .appendTo( '#pengeluaran-all_wrapper .col-sm-6:eq(0)' ); 
            },
                processing: true,
                serverSide: true, //aktifkan server-side 
                ajax: {
                    url: "{{ url('/pengeluaran/all') }}",
                    type: 'GET',
        ...
        $('#filter').click(function(){
            ...
            if(from_date != '' &&  to_date != '')
                {
                    $('#pengeluaran-all').DataTable().destroy();
                ...
                $.ajax({
                    ...
                    success: function (data) { //jika sukses
                        setTimeout(function () {
                            ...
                            var oTable = $('#pengeluaran-all').dataTable();
